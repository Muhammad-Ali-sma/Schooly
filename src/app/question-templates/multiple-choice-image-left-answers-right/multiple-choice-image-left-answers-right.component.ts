...
@Component({
  selector: 'app-multiple-choice-image-left-answers-right',
  templateUrl: './multiple-choice-image-left-answers-right.component.html',
  styleUrls: ['./multiple-choice-image-left-answers-right.component.css']
})
export class MultipleChoiceImageLeftAnswersRightComponent implements OnInit, OnChanges {
