...
@Component({
  selector: 'app-multiple-choice-image-right-answers-left',
  templateUrl: './multiple-choice-image-right-answers-left.component.html',
  styleUrls: ['./multiple-choice-image-right-answers-left.component.css']
})
export class MultipleChoiceImageRightAnswersLeftComponent implements OnInit, OnChanges {
